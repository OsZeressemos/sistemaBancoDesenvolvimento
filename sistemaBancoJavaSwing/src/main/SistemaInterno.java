...
public class SistemaInterno {
	...
	public static void main(String[] args) {
		ImageIcon icon = new ImageIcon("E:\\CURSOS\\Digital Innovation One\\jogo da cobrinha\\img\\favicon\\snake2.png");
		...
		JOptionPane.showMessageDialog(null, "                      ZERESSEMOS BANK", "", JOptionPane.QUESTION_MESSAGE);
